        ...
        <div class="flex">
            ...
            <div class="inputBox">
                ...
                <select name="method">
                    ...
                    <option value="credit card">CBE</option>
            ...
            <!-- <div class="inputBox">
                ...
                <input type="text" name="flat" placeholder="e.g. kolfe.">
            </div> -->
            <!-- <div class="inputBox">
            ...
            <div class="inputBox">
                <span>city :</span>
                <input type="text" name="city" placeholder="e.g. Addis Ababa">
            </div>
            <div class="inputBox">
                <span>state :</span>
                <input type="text" name="state" placeholder="e.g. oromia">
            </div>
            <div class="inputBox">
                <span>country :</span>
                <input type="text" name="country" placeholder="e.g. Ethiopia">
            </div>
            <div class="inputBox">
                <span>pin code :</span>
